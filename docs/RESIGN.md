...
**普通用户推荐直接使用 [Mac / Windows 整合包](https://github.com/thx853068675-dev/quietstart-installer/blob/main/USAGE.md)**：助手、HAP 在同一个 ZIP 中，点击“选择 HAP → 开始调试”，自动处理内外模块，无需 DevEco、SDK 或脚本。
